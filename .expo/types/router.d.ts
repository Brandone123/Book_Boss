...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/DispatchModule/ActiveLoad` | `/DispatchModule/DispatchDashboard` | `/DispatchModule/DispatchDetail` | `/DispatchModule/DispatchList` | `/DispatchModule/DispatchMap` | `/DispatchModule/LoadList` | `/DispatchModule/_layout` | `/ModuleContext` | `/screens/Accident` | `/screens/Assistance` | `/screens/Contact` | `/screens/Login` | `/screens/Modal` | `/YardCheckModule/ParkingInfo` | `/YardCheckModule/YardDashboard` | `/YardCheckModule/YardHistory` | `/YardCheckModule/YardList` | `/YardCheckModule/YardMap` | `/YardCheckModule/YardReservation` | `/YardCheckModule/_layout`;
  // prettier-ignore
